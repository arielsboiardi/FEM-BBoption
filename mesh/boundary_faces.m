function [bdF, bdV]=boundary_faces(T)
% boundary_facess compute the faces of the tetrahedra that lie ond the
% boundary of the domain 3D. 
%
% Input:
%   T       delunayTriangulation 
%
% Output:
%   bdF     Faces of tetrahedra lying on the boundary of the domain
%   bdV     Nodes of the mesh on the boundary
